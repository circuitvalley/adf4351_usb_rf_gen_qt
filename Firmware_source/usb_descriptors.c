...
{
    sd003.string [9 - 4] = 0x41 + ( (serial_number_flash >> 12) & 0xF ); 
    sd003.string [9 - 3] = 0x41 + ( (serial_number_flash >> 8) & 0xF ); 
    sd003.string [9 - 2] = 0x41 + ( (serial_number_flash >> 4) & 0xF ); 
    sd003.string [9 - 1] = 0x41 + ( (serial_number_flash ) & 0xF );
